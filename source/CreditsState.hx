...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Vs Fear Team'],
		['DEMOLITIONDON96',     'demolitiondon96',  'Owner of Mr. Fear & Mod Director',                 'https://www.youtube.com/channel/UC1i717yXQyTqjwWg-KZY8Eg',    0xFF03BEFC],
		['Bopaku',              'bopaku',           'Made Some of the Charts',                          'https://twitter.com/OogaBoo82101064',    0xFFA8E9FF],
		['Biscuit',             'biscuit',          'Also Made Charts',                                 'https://www.twitter.com/Axo_But_Bad',    0xFFFF5B3B],
		['TrevorAnimates',      'trevoranimates',   'Animator',                                         'https://m.youtube.com/channel/UCT7SqVcstg8unPx-Sy6ex9w',    0xFF0099FF],
		[''],
		['Psych Engine Team'],
